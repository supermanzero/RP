...
$(".cmspages-content-menu-bd").on("click","li",function(){
    $(this).toggleClass("on")
})

var bdHeight=($(window).height())-110;
$(".cmspages-content-menu,.cmspages-content").css({"height":bdHeight})
$(window).resize(function(){
    bdHeight=($(window).height())-110;
    $(".cmspages-content-menu,.cmspages-content").css({"height":bdHeight})
})